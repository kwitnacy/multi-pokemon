...
class Query:
    ...
    def insert_ID (self,instance):
        switch={
            'User':self.db.execute_otherdb("INSERT INTO  `Users` (user_ID, user_name, passwd_hash) VALUES ("+str(instance.user_ID)+ ", \""+instance.user_name+"\", \""+instance.passwd_hash+"\")","pokemon"),
    ...
    def insert_no_ID (self,instance):
        # switch={
        #     'User':self.db.execute_otherdb("INSERT INTO  `Users` (user_name, passwd_hash) VALUES ("+ " \""+instance.user_name+"\", \""+instance.passwd_hash+"\")","pokemon"),
        ...
        if instance_name == 'User':
            self.db.execute_otherdb("INSERT INTO  `Users` (user_name, passwd_hash) VALUES ("+ " \""+instance.user_name+"\", \""+instance.passwd_hash+"\")","pokemon")
        elif instance_name == 'Pokemon':
            self.db.execute_otherdb("INSERT INTO  `Pokemons` (`Pokemon_name`,`Pokemon_lv`,`Pokemon_exp_to_level`,`Pokemon_move1_ID`,`Pokemon_move2_ID`,`Pokemon_move3_ID`,`Pokemon_move4_ID`,`Poke_ID`,`Char_ID`) VALUES ("+"\""+instance.Pokemon_name+"\", "+str(instance.Pokemon_lv)+","+str(instance.Pokemon_exp_to_level)+","+ str(instance.Pokemon_move1_ID)+","+ str(instance.Pokemon_move2_ID)+","+ str(instance.Pokemon_move3_ID)+","+ str(instance.Pokemon_move4_ID)+","+ str(instance.Poke_ID)+","+ str(instance.Char_ID)+")","pokemon")
        elif instance_name == 'World':
            self.db.execute_otherdb("INSERT INTO  `Worlds` (World_ID, World_name ) VALUES ("+ " \""+instance.World_name+"\""+")","pokemon"),
        elif instance_name == 'Character':
            self.db.execute_otherdb("INSERT INTO  `Characters` (user_ID, World_ID, Char_name) VALUES ("+" "+str(instance.user_ID)+", "+str(instance.World_ID)+",\""+instance.Char_name+"\")","pokemon"),
